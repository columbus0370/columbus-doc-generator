...
export default function EmailDraftModal({ clientName, companyName, workTypeLabel, totalAmount, deadline, onClose }) {
      ...
      <div className="w-full max-w-lg bg-navy-800 border border-navy-700 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-navy-700">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-0.5">AIが生成した文面です。自由に編集できます</p>
          </div>
            ...
            <>
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="button"
                  onClick={handleCopy}
                  className="flex-1 bg-accent hover:bg-accent-hover text-white font-bold px-6 py-2.5 rounded-lg transition-colors text-sm flex items-center justify-center gap-2"
                >
                  {copied ? (
                    <>
                      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
